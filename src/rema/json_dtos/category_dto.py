...
class Exhaustive:
    ...
    def from_dict(obj: Any) -> "Exhaustive":
        ...
        facets_count = from_union([from_bool, from_none], obj.get("facetsCount"))
...
class CategoryNameClass:
    ...
    def from_dict(obj: Any) -> "CategoryNameClass":
        ...
        match_level = from_union([MatchLevel, from_none], obj.get("matchLevel"))
        matched_words = from_union(
            [lambda x: from_list(lambda x: x, x), from_none], obj.get("matchedWords")
        )
...
class HighlightResult:
    ...
    def from_dict(obj: Any) -> "HighlightResult":
        assert isinstance(obj, dict)
        id = from_union([CategoryNameClass.from_dict, from_none], obj.get("id"))
        name = from_union([CategoryNameClass.from_dict, from_none], obj.get("name"))
        hf2 = from_union([CategoryNameClass.from_dict, from_none], obj.get("hf2"))
        category_name = from_union(
            [CategoryNameClass.from_dict, from_none], obj.get("category_name")
        )
        labels = from_union(
            [lambda x: from_list(CategoryNameClass.from_dict, x), from_none],
            obj.get("labels"),
        )
    ...
    def to_dict(self) -> dict:
        ...
        if self.category_name is not None:
            result["category_name"] = from_union(
                [lambda x: to_class(CategoryNameClass, x), from_none],
                self.category_name,
            )
        if self.labels is not None:
            result["labels"] = from_union(
                [
                    lambda x: from_list(lambda x: to_class(CategoryNameClass, x), x),
                    from_none,
                ],
                self.labels,
            )
...
class NutritionInfo:
    ...
    def from_dict(obj: Any) -> "NutritionInfo":
        assert isinstance(obj, dict)
        sort = from_union([from_none, lambda x: int(from_str(x))], obj.get("sort"))
...
class Pricing:
    ...
    def from_dict(obj: Any) -> "Pricing":
        ...
        max_quantity = from_union([from_int, from_none], obj.get("max_quantity"))
        price_over_max = from_union([from_float, from_none], obj.get("price_over_max"))
        is_on_discount = from_union([from_bool, from_none], obj.get("is_on_discount"))
        normal_price = from_union([from_float, from_none], obj.get("normal_price"))
        price_per_kilogram = from_union(
            [from_float, from_none], obj.get("price_per_kilogram")
        )
        price_per_unit = from_union([from_str, from_none], obj.get("price_per_unit"))
        ...
        is_advertised = from_union([from_bool, from_none], obj.get("is_advertised"))
...
class Hit:
    ...
    def from_dict(obj: Any) -> "Hit":
        ...
        wine_type_labels = from_union(
            [lambda x: from_list(lambda x: x, x), from_none],
            obj.get("wine_type_labels"),
        )
        season_labels = from_union(
            [lambda x: from_list(lambda x: x, x), from_none], obj.get("season_labels")
        )
        review_labels = from_union(
            [lambda x: from_list(lambda x: x, x), from_none], obj.get("review_labels")
        )
        fits_with_labels = from_union(
            [lambda x: from_list(lambda x: x, x), from_none],
            obj.get("fits_with_labels"),
        )
        description = from_union([from_str, from_none], obj.get("description"))
        description_short = from_union(
            [from_str, from_none], obj.get("description_short")
        )
        hp_statements = from_union(
            [lambda x: from_list(lambda x: x, x), from_none], obj.get("hp_statements")
        )
        declaration = from_union([from_str, from_none], obj.get("declaration"))
        declaration_old = from_union([from_str, from_none], obj.get("declaration_old"))
        nutrition_info = from_union(
            [lambda x: from_list(NutritionInfo.from_dict, x), from_none],
            obj.get("nutrition_info"),
        )
        nutrition_info_old = from_union(
            [lambda x: from_list(lambda x: x, x), from_none],
            obj.get("nutrition_info_old"),
        )
        image_url = from_union([from_str, from_none], obj.get("image_url"))
        have_image = from_union([from_bool, from_none], obj.get("have_image"))
        bar_codes = from_union(
            [lambda x: from_list(from_str, x), from_none], obj.get("bar_codes")
        )
        search_words = from_union(
            [lambda x: from_list(from_str, x), from_none], obj.get("search_words")
        )
        sorting = from_union([from_int, from_none], obj.get("sorting"))
        is_weight_item = from_union([from_bool, from_none], obj.get("is_weight_item"))
        median_weight = from_union([from_int, from_none], obj.get("median_weight"))
        ...
        assortment_code = from_union([from_int, from_none], obj.get("assortment_code"))
        ...
        warnings = from_union(
            [lambda x: from_list(lambda x: x, x), from_none], obj.get("warnings")
        )
        department_id = from_union([from_int, from_none], obj.get("department_id"))
    ...
    def to_dict(self) -> dict:
        ...
        if self.underline is not None:
            result["underline"] = from_union([from_str, from_none], self.underline)
        if self.hf2 is not None:
        ...
        if self.declaration is not None:
            result["declaration"] = from_union([from_str, from_none], self.declaration)
        ...
        if self.nutrition_info is not None:
            result["nutrition_info"] = from_union(
                [
                    lambda x: from_list(lambda x: to_class(NutritionInfo, x), x),
                    from_none,
                ],
                self.nutrition_info,
            )
        ...
        if self.median_weight_unit is not None:
            result["median_weight_unit"] = from_union(
                [lambda x: to_enum(MedianWeightUnit, x), from_none],
                self.median_weight_unit,
            )
        ...
        if self.modified_at is not None:
            result["modified_at"] = from_union([from_int, from_none], self.modified_at)
        if self.highlight_result is not None:
            result["_highlightResult"] = from_union(
                [lambda x: to_class(HighlightResult, x), from_none],
...
class Request:
    ...
    def to_dict(self) -> dict:
        ...
        if self.round_trip is not None:
            result["roundTrip"] = from_union([from_int, from_none], self.round_trip)
        return result
...
class CategoryDto:
    ...
    def from_dict(obj: Any) -> "CategoryDto":
        assert isinstance(obj, dict)
        hits = from_union(
            [lambda x: from_list(lambda x: Hit.from_dict, x), from_none],
            obj.get("hits"),
        )
        ...
        hits_per_page = from_union([from_int, from_none], obj.get("hitsPerPage"))
        ...
        exhaustive_typo = from_union([from_bool, from_none], obj.get("exhaustiveTypo"))
        ...
        server_time_ms = from_union([from_int, from_none], obj.get("serverTimeMS"))
        return CategoryDto(
            hits,
            nb_hits,
            page,
    ...
    def to_dict(self) -> dict:
        ...
        if self.nb_pages is not None:
            result["nbPages"] = from_union([from_int, from_none], self.nb_pages)
        ...
        if self.rendering_content is not None:
            result["renderingContent"] = from_union(
                [lambda x: to_class(RenderingContent, x), from_none],
                self.rendering_content,
            )
        ...
        if self.processing_timings_ms is not None:
            result["processingTimingsMS"] = from_union(
                [lambda x: to_class(ProcessingTimingsMS, x), from_none],
                self.processing_timings_ms,
            )
